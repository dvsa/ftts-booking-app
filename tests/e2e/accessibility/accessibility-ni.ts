...
import {
  click, setCookie, clearField, runningTestsLocally, verifyContainsText,
} from '../utils/helpers';
...
fixture`Online booking app accessibility tests - DVA (NI)`
  ...
  .beforeEach(async () => {
    ...
    drivingLicence = runningTestsLocally() ? Constants.drivingLicenceNI : drivingLicenceForEnvironment;
...
test('Accessibility test - Candidate details with support page', async (t) => {
  ...
  await verifyContainsText(candidateDetailsPage.pageHeadingLocator, candidateDetailsPage.pageHeadingSupport);
});
...
test('Accessibility test - Theory test type page', async (t) => {
  ...
  await t.navigateTo(`${baseUrl}/${t.ctx.page}`);
  await verifyContainsText(testTypePage.pageHeadingLocator, testTypePage.pageHeading);
});
...
test('Accessibility test - Find a theory test centre page', async (t) => {
  ...
  await t.navigateTo(`${baseUrl}/${t.ctx.page}`);
  await verifyContainsText(findATheoryTestCentrePage.pageHeadingLocator, findATheoryTestCentrePage.pageHeading);
});
...
test('Accessibility test - Find a theory test centre error page', async (t) => {
  ...
  await verifyContainsText(findATheoryTestCentreErrorPage.pageHeadingLocator, findATheoryTestCentreErrorPage.pageHeading);
});
...
test('Accessibility test - Select a theory test centre page', async (t) => {
  ...
  await t.navigateTo(`${baseUrl}/${t.ctx.page}`);
  await verifyContainsText(chooseATestCentrePage.pageHeadingLocator, chooseATestCentrePage.pageHeading);
});
...
test('Accessibility test - What do you want to change page', async (t) => {
  ...
  await t.navigateTo(`${baseUrl}/${t.ctx.page}`);
  await verifyContainsText(whatDoYouWantToChangePage.pageHeadingLocator, whatDoYouWantToChangePage.pageHeading);
});
...
test('Accessibility test - NSA Booking confirmation page', async (t) => {
  ...
  await verifyContainsText(bookingConfirmationPage.pageHeadingLocator, bookingConfirmationPage.pageHeadingNSA);
});
...
test('Accessibility test - Login page - with error', async (t) => {
  ...
  await verifyContainsText(loginPage.errorMessageLocator, loginPage.errorMessageMissing);
  await verifyContainsText(loginPage.pageHeadingLocator, loginPage.pageHeading);
});
...
test('Accessibility test - Cancel bookings page', async (t) => {
  ...
  await verifyContainsText(cancelBookingPage.pageHeadingLocator, cancelBookingPage.pageHeading);
});
...
if (runningTestsLocally()) {
  test('Accessibility test - Cancelled bookings page', async (t) => {
    ...
    await verifyContainsText(cancelledBookingPage.pageHeadingLocator, cancelledBookingPage.pageHeading);
  });
}
...
test('Accessibility test - Manage booking - Confirmed change page', async (t) => {
  ...
  await verifyContainsText(changeConfirmedPage.pageHeadingLocator, changeConfirmedPage.pageHeading);
});
...
test('Accessibility test - Staying NSA page', async (t) => {
  ...
  await verifyContainsText(stayingNSAPage.pageHeadingLocator, stayingNSAPage.pageHeading);
});
...
test('Accessibility test - Leaving NSA page', async (t) => {
  ...
  await verifyContainsText(leavingNsaPage.pageHeadingLocator, leavingNsaPage.pageHeading);
});
...
test('Accessibility test - NSA Voicemail page', async (t) => {
  ...
  await verifyContainsText(nsaVoicemailPage.pageHeadingLocator, nsaVoicemailPage.pageHeading);
});
...
test('Accessibility test - NSA Telephone contact page', async (t) => {
  ...
  await verifyContainsText(nsaTelephoneContactPage.pageHeadingLocator, nsaTelephoneContactPage.pageHeading);
});
...
test('Accessibility test - NSA Custom support page', async (t) => {
  ...
  await verifyContainsText(customSupportPage.pageHeadingLocator, customSupportPage.pageHeading);
});
...
test('Accessibility test - NSA Translator page', async (t) => {
  ...
  await t.navigateTo(`${baseUrl}/${translatorPage.pathUrl}?target=${Target.NI}`);
...
async function runAxeCheck(t: TestController) {
  ...
  const { error, results } = await runAxe('', { rules: { 'color-contrast': { enabled: false } } });
