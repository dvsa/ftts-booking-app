...
export class CancelBookingPage extends BasePage {
  ...
  textLocator4 = 'a.govuk-body';

  textLocator6 = '.govuk-inset-text';

  backLink = '.govuk-back-link';

  cancelButtonLocator = '.govuk-button';

  keepButtonLocator = '.govuk-button.govuk-button--secondary';
  ...
  text4 = 'placeholder@dvsa.gov.uk';

  text5 = 'Telephone 01234 567890';
