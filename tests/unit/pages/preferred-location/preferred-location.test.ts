...
import { PreferredLocationController } from '@pages/preferred-location/preferred-location';
...
describe('Preferred Location controller', () => {
  ...
  describe('GET request', () => {
    test('renders the preferred location page with saved text & options', () => {
      ...
      expect(res.render).toHaveBeenCalledWith(PageNames.PREFERRED_LOCATION, {
        errors: [],
