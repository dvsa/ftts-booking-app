import { InstructorCheckYourDetailsController } from '@pages/instructor-check-your-details/instructor-check-your-details';
...
describe('Instructor Check Your Details controller', () => {
  ...
  describe('GET request', () => {
    test('renders check-your-details page', () => {
      ...
      expect(res.render).toHaveBeenCalledWith(PageNames.INSTRUCTOR_CHECK_YOUR_DETAILS,
        {
          firstNames: 'Test',
          surname: 'User',
          dateOfBirth: '1990-01-01',
    ...
    test('DVA context presents translator option', () => {
      ...
      expect(res.render).toHaveBeenCalledWith(PageNames.INSTRUCTOR_CHECK_YOUR_DETAILS, expect.objectContaining({
