...
import { InstructorSelectTestCentreController } from '@pages/instructor-select-test-centre/instructor-select-test-centre';
...
describe('InstructorSelectTestCentreController', () => {
  ...
  describe('get', () => {
    test('should update the number of results in the session if one is provided via query string', async () => {
      ...
      expect(res.render).toHaveBeenCalledWith(PageNames.INSTRUCTOR_SELECT_TEST_CENTRE, {
        centres: mockCentres,
    ...
    describe('html escaping', () => {
      ...
      test('passes an html-escaped address for the frontend js map to use', async () => {
        ...
        expect(res.render).toHaveBeenCalledWith(PageNames.INSTRUCTOR_SELECT_TEST_CENTRE, expect.objectContaining({
  ...
  describe('post', () => {
    ...
    test('re-renders page if has errors', async () => {
      ...
      expect(res.render).toHaveBeenLastCalledWith(PageNames.INSTRUCTOR_SELECT_TEST_CENTRE, expect.any(Object));
    });
