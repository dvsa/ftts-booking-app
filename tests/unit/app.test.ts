  ...
  test('Nunjucks is configured', () => {
    ...
    expect(nunjucks.configure).toHaveBeenCalledWith(
      expect.arrayContaining([
        ...
        expect.stringContaining('/nunjucks-govuk/'),
        expect.stringContaining('/nunjucks-includes/'),
        expect.stringContaining('/nunjucks-layouts/'),
        expect.stringContaining('/nunjucks-macros/'),
