...
export default {
  subject: 'cy-DVSA: your driving theory test has been cancelled',
  buildBody: (details: BookingCancellationDetails): string => dedent`
    # cy-Your ${translate(`generalContent.testTypes.${details.testType}`)} driving theory test is cancelled
    ...
    Tests cancelled more than 3 clear working days from the test date will be refunded.
