...
export default {
  subject: 'ni-DVA: your driving theory test has been updated',
  buildBody: (details: BookingRescheduledDetails): string => {
    ...
    return dedent`
    # ni-Your driving theory test details has been updated
    ...
    * the test fee may not be refunded
    ...
    Check, reschedule or cancel this test here:
    https://www.nidirect.gov.uk/services/book-change-or-cancel-your-theory-test-online

    ---

    https://www.nidirect.gov.uk/information-and-services/motoring/learners-and-new-drivers
  `;
  },
};
